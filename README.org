...
| *Name*     | *Location*           | *Profile*    | *default* |
|------------+----------------------+--------------+-----------|
| [[#legacy][Legacy]]     | [[file:.my-emacs/myinit.org][.my-emacs/myinit.org]] | =legacy=     | Yes       |
| [[#evil-basic][Evil Basic]] | [[file:.evil-basic/init.el][.evil-basic/init.el]]  | =evil-basic= | No        |
| [[#new][New]]        | [[file:.new-emacs/init.el][.new-emacs/init.el]]   | =new=        | No        |
